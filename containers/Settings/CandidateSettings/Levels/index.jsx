...
import { useCRUDCandidateSources } from "services/crud/useCRUDCandidateSources";
...
import { useCRUDCandidateLevels } from "services/crud/useCRUDCandidateLevels";
...
export default function CandidateLevels() {


    const { data, mutate } = useGetCandidateLevels();
        ...
        _action: <div>
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Edit candidate source' onSubmit={async (values) => onEdit(item.id, values)} defaultValues={{
                        name: item.name
                    }}></Form>
                </DialogContent>
            </Dialog>
    ...
    const { create, update, remove } = useCRUDCandidateLevels();
    ...
    return <div>
        <div style={{ display: "flex", justifyContent: 'space-between', alignItems: "center", padding: 5 }}>
            <span><b>Candidate Sources</b></span>
            <DropdownMenu  >
            ...
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Add candidate source' onSubmit={onAdd}></Form>
                </DialogContent>
            </Dialog>
        </div>
