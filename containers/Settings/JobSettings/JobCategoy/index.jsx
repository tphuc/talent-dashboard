...
import { useCRUDJobCategories } from "services/crud/useCRUDJobCategories";
...
export default function JobCategorySettings() {
    ...
    const { data, mutate } = useGetJobCategories();
        ...
        _action: <div>
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Edit job category' onSubmit={async (values) => onEdit(item.id, values)} defaultValues={{
                        name: item.name
                    }}></Form>
                </DialogContent>
            </Dialog>
    ...
    const { create, update, remove } = useCRUDJobCategories();
    ...
    return <div style={{ position: "relative", width: "100%" }}>
        <div style={{ display: "flex", width: "100%", position: "absolute", justifyContent: 'space-between', alignItems: "center", padding: 5 }}>
            <span><b>Job Categories</b></span>
            <DropdownMenu  >
            ...
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Add job category' onSubmit={onAdd}></Form>
                </DialogContent>
            </Dialog>
        </div>
