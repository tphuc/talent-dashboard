...
import { useCRUDCommissionKPI } from "services/crud/useCRUDComissionKPI";
import { useGetCommissionKPIs } from "services/swr/useGetCommissionKPIs";
...
export default function SettingCommissionKpi() {


    const { data, mutate } = useGetCommissionKPIs();
        ...
        _action: <div>
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Edit commission KPI' onSubmit={async (values) => onEdit(item.id, values)} defaultValues={{
                        name: item.name
                    }}></Form>
                </DialogContent>
            </Dialog>
    ...
    const { create, update, remove } = useCRUDCommissionKPI();
