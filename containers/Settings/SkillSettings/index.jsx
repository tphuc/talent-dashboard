...
export default function SettingSkills() {
    ...
    const { data, mutate } = useGetSkills();
        ...
        _action: <div>
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Edit skill' onSubmit={async (values) => onEdit(item.id, values)} defaultValues={{
                        name: item.name
                    }}></Form>
                </DialogContent>
            </Dialog>
    ...
    const { create, update, remove } = useCRUDSkills();
    ...
    return <div>
        ...
        <div style={{ display: "flex", justifyContent: 'space-between', alignItems: "center", padding: 5 }}>
            ...
            <Dialog modal>
                ...
                <DialogContent css={{ maxWidth: 400 }} >
                    <Form title='Add new skill' onSubmit={onAdd}></Form>
                </DialogContent>
            </Dialog>
        </div>
