        ...
        <Box>
            <Box css={{ display: 'flex', alignItems: "stretch", gap: 10, flexWrap: "wrap", justifyContent: "space-between" }}>
                <Card css={{ textAlign: "center", flex: 1, }}>
                    <Text css={{ mt: 0, color: "inherit" }} >TOTAL CANDIDATES</Text>
                    <Text css={{ fontWeight: 500, color: "inherit" }}>2000</Text>

                </Card>
                <Card css={{ textAlign: "center", flex: 1, color: "$violet11" }}>
                    <Text css={{ mt: 0, color: "inherit" }} >TOTAL APPLICATIONS</Text>
                    <Text css={{ fontWeight: 500, color: "inherit" }}>2000</Text>
                    <Box css={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(50%, 1fr))", justifyItems:"start" }}>
                        <span style={{ fontSize: 'small' }}>Applied: 150</span>
                        <span style={{ fontSize: 'small' }}>Interviewed: 150</span>
                        <span style={{ fontSize: 'small' }}>Offered: 150</span>
                        <span style={{ fontSize: 'small' }}>Onboard: 150</span>
                    </Box>

                </Card>
                <Card css={{ textAlign: "center", flex: 1, color: "$orange10" }}>
                    <Text css={{ mt: 0, color: "inherit" }} >AVG TIME APPLY</Text>
                ...
                <Card css={{ textAlign: "center", flex: 1, color: "$blue10" }}>
                    <Text css={{ mt: 0, color: "inherit" }} >HIRED</Text>
                    <Text css={{ fontWeight: 500, color: "inherit" }}>2000</Text>
                </Card>
            </Box>
            <br />
